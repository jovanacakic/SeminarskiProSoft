...
//    }
    ...
    protected void popuniTabelu(List<Predmet> predmeti) {
        if (predmeti == null) {
            predmeti = PredmetKontroler.getInstance().ucitajListuPredmeta(predmeti);
        }

        SubjectTableModel stm = new SubjectTableModel(predmeti);
        tblPredmeti.setModel(stm);
    }
