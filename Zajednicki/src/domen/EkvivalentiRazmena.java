...
public class EkvivalentiRazmena extends AbstractDomainObject {
    ...
    public EkvivalentiRazmena(EkvivalentiRazmena original) {
        this.rb = original.rb;
        //this.razmena = original.razmena;
        this.razmena = new Razmena();
        this.razmena.setRazmenaID(original.razmena.getRazmenaID());
        this.ekvivalenti = original.ekvivalenti; // Isto kao gore, plitka ili duboka kopija
